...
router.get('/orders/invoice/:orderId', auth, getInvoicePDF_Orders)
router.get('/update-payment/:id', auth, updatePayment)

router.post('/create-pending-order', createPendingOrder)
router.post('/orders/load-to-cart/:orderId', auth, loadOrderToCart)
...
router.patch('/admin/orders/complete/:orderId', auth, admin, markOrderCompleted)
router.get('/admin/invoice/:orderId', auth, getInvoicePDF_Admin)
